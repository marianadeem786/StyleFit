...
from .views import (
    ...
    advanced_search_view, suggest_match_view, find_similar_view, trendy_outfits_view,wardrobe_outfits_view, recommend_wardrobe_view, logout_view, sort_by_price_view
)
...
urlpatterns = [
    ...
    path("price_view/", sort_by_price_view, name='price_view'),
]
